/*
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body ja tenha a clasee modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    Executa mesma função if else, codigo seguinte
    */
